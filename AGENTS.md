...
**Verify Before Narrating Success (Critical - Recurrence 3)**
Claim "done/set up/success" without filesystem verification erodes trust.
HARD RULE: Before ANY success narration, chain `exec ls -la <expected paths/files>`. Include raw output in response. No exceptions, even if obvious.
