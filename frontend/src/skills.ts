...
export const SKILLS: Skill[] = [
  ...
  { category: "Info", name: "Web search", description: "Search the web. Contact details, showtimes, lookups. DuckDuckGo or OpenRouter :online.", examples: ["search for Python tutorial", "get me contact details for Acme Corp", "when is showtimes of Dune at VUE Sheffield"] },
  ...
  { category: "Info", name: "Interactive browsing (OpenRouter)", description: "Navigate, click, fill forms. Access authenticated sites with storage-state. Requires OpenRouter and GERTY_BROWSE_ENABLED=1.", examples: ["go to example.com and find the pricing page", "check my GitHub notifications", "visit python.org and get the latest version"] },
  { category: "Integrations", name: "App actions (MCP/Rube)", description: "Send emails, create tasks, post to Slack, update Notion, GitHub, Linear, etc. Requires COMPOSIO_API_KEY.", examples: ["send an email to John about the meeting", "create a Notion task for the report", "post to Slack that I'm done"] },
